...
export default function recomendationSection({ contents }) {
  return (
    <div>
      <p className="text-2xl font-bold my-5">추천</p>
      <div className="overflow-y-hidden overflow-x-auto whitespace-nowrap m-2">
        {contents.map((content, idx) => {
          const padding = idx !== contents.length - 1 ? 4 : 0;
          const section = content.title ? 'movie' : 'tv';
          return (
            <div className={`inline-block pr-${padding} rounded-md`}>
